...
Only interested in activists? The [activist ownership API](/api/activist-ownership/activist-ownership) is a dedicated view of the same data, pinned to activist stakes and updated in real time.
