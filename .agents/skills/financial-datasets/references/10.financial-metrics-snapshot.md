...
> Get a real-time snapshot of current financial metrics and valuation ratios for any US stock ticker.
...
```python Financial Metrics Snapshot theme={"theme":{"light":"vitesse-light","dark":"vitesse-dark"}}
import requests
...
````yaml GET /financial-metrics/snapshot
openapi: 3.0.1
info:
